...
export const toolConfigFixtures: ToolConfig[] = [
  ...
  { id: "antigravity", name: "Antigravity", skillsPath: "/Users/demo/.gemini/antigravity/skills", mcpConfigPath: "/Users/demo/.gemini/antigravity/mcp_config.json", supportsMcp: true, mcpConfigPathRecognized: true, statusLabel: "已安装", isEnabled: true, primaryType: "editor", surfaceTypes: ["editor"], supportsDirectOpen: true },
  { id: "windsurf", name: "Windsurf", skillsPath: "/Users/demo/.codeium/windsurf/skills", mcpConfigPath: "/Users/demo/.codeium/windsurf/mcp_config.json", supportsMcp: true, mcpConfigPathRecognized: true, statusLabel: "已安装", isEnabled: true, primaryType: "editor", surfaceTypes: ["editor"], supportsDirectOpen: true },
  { id: "intellij", name: "IntelliJ IDEA", skillsPath: "/Users/demo/.intellij/skills", mcpConfigPath: "", supportsMcp: false, mcpConfigPathRecognized: false, statusLabel: "已安装", isEnabled: true, primaryType: "editor", surfaceTypes: ["editor"], supportsDirectOpen: true },
  ...
  { id: "goose", name: "Goose", skillsPath: "/Users/demo/.config/goose/skills", mcpConfigPath: "/Users/demo/.config/goose/config.yaml", supportsMcp: true, mcpConfigPathRecognized: true, statusLabel: "未安装", isEnabled: false, primaryType: "cli", surfaceTypes: ["cli"], supportsDirectOpen: false },
