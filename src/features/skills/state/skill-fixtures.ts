...
export const toolConfigFixtures: ToolConfig[] = [
  ...
  { id: "antigravity", name: "Antigravity", skillsPath: "/Users/demo/.gemini/config/skills", mcpConfigPath: "/Users/demo/.gemini/antigravity/mcp_config.json", supportsMcp: true, mcpConfigPathRecognized: true, statusLabel: "已安装", isEnabled: true, primaryType: "desktop", surfaceTypes: ["desktop", "cli"], supportsDirectOpen: false },
