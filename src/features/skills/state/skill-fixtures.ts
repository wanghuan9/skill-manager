  ...
  projects: [
    {
      ...
      skills: [
        ...
        },
        {
          ...
          name: "skill-publisher",
          description: "用于维护技能发布说明、变更记录和发布前检查脚本。",
          relativePath: ".cursor/skills/skill-publisher",
          localPath: "/Users/demo/Projects/demo-workspace/.cursor/skills/skill-publisher",
          entryKind: "directory",
          isEnabled: false,
          managedSkillPath: "/Users/demo/.skilldock/skills/skill-publisher",
          projectCapability: "bidirectional",
          contentHash: "fixture-skill-publisher-cursor",
          syncStatus: "project-changed",
          error: "",
        },
        {
          toolId: "codex",
